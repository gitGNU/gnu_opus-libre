...
UnPianoMd = \relative {
  ...
  r4\cresc <lab sol'>32^( re8..)\laissezVibrer
  ...
  \pl {re4_(^\< \set tieWaitForNote = ##t sib~-- fad'2~--)^\!
  <sib, fad'>1\laissezVibrer }
  {la'1~ la\laissezVibrer } | r2\ppp
  \pl <red, sol! do>\fermata\laissezVibrer
...
UnPianoMg = \relative {
  ...
  sol,( sol' \t {fad'-- sol, sol)} |
  \pl { sol,2 sol'_"sempre con Ped." sol si si si sol! sol
  ...
  \t {<mib lab>8_"(con Ped.)" sol <mib lab>} \t {sol <mib lab> sol}
  ...
  { \t {r8 <do' fa>_( re} <do fa>4~) \oneVoice <sol do fa>2*5/4
  \voiceOne \t {mib'8_( re <mib sol>~} <do sol'>4~) <do sol'>2*5/4 }
  \set tieWaitForNote = ##t
  \t {sol4~^( re'~ fad~)} %%FIXME: tieWaitForNote doesn't work?!
  <sol, re' fad>2 | \set tieWaitForNote = ##f
...
DeuxPianoMd = \relative {
  ...
  {
    <mi'' si'!>^>_( sib <sib mi> fa)
    sol^( fa <sib mi> mi)
    <mi si'!>^>_( sib <sib mi> fa)
    sol^( fa <sib mi> mi) |
    <mi si'!>^>_( sib sol) <sib mi>^>(
    %%FIXME: Issue #984
    fa red) <re'! sol>^>( la)
  ...
  {
    <mib' lab>^> re-"più secco" <mib lab> reb
    <re lab'> do <re lab'> la
    <mib' lab> lab, <mib' lab> lab,
    <re lab'> la <re lab'> la
    <re sol>\dim lab <re sol> lab
  ...
  <lab do mib sol>2.*5/3)\mp\laissezVibrer R1*5/4
  \clef bass
  mi,4.->-"en dehors"^\< fa8 sol sib4.~->^\! sib1~ sib |
  \pl {\oneVoice mi,4.->^_\f_\< fa8 sol \voiceTwo lad4._\!-> s}
  { s8*5 \longHairpin si!4^\< do8 \oneVoice <re, re'>4.^\! }
  \acciaccatura <mib'' fad>16 <fa,! re'>8~->
  <fa re'>2~ <fa re'>1 |
  <mib fad re'>--\p\> <re? fad dod'>--\! <re sol dod>2 |
  <mib la? re>4--\mp q2 q2.-- <solb mib' fa>4-- q2 q2.-- |
  \clef treble
  \longHairpin <fa do'? solb'>4--\mf\< q2 <do'? solb' si>2->--\!( <fa, do' solb'>4) |
...
DeuxPianoMg = \relative {
  ...
  <reb reb'>2*2_\!\laissezVibrer R1.
  R1*3
  fa'8_"non legato" lab fa la fa lab fa la fa lab fa r |
  <mi,, mi'>4--_\pp q1 q4-- q1 |
  \ottava #-1
  \pl
  {
    mi4. fa8 sol sib4.~ sib1~ sib1
    mi,4. fa8 sol lad4.
    <mi mi'>4 mi2. mi4_\dyn "(pp)" mi2. mi4 <mi mi'>2.
    %%FIXME: issue #1110
    <mi red'>4-- <mi red'>2 <mi red'>4
  }
  {
    mi4 <mi mi'>2.
    <mi mi'>4_- _\dyn "pp_sempre" <mi mi'>2.
    <mi mi'>4_- <mi mi'>2.
...
TroisPianoMg = \relative {
  ...
  }
  {
    ...
    <mi, re'>8--(~\dim <la sol'>)~ <re sol>2.~ <re sol>2\!
  }
  r2\fermata
}
