...
\relative do' {
  ...
  do sol mi sol mi sol mi sol re' la fa la mi' si sol si
  \clef treble
  fa' do la do sol' re la' mi si' mi, do' fa, dod' fa, re' fad,
  % 1 %
  ...
  % 4 %
  mi mi, mi' red red dod dod si si la la sold sold fad fad mi
  si' do, fad red' do, si' fad red' do, si' red fad, si do, red' fad,
  sol fa' do dod, re' red, la' sib, si' do, sol fa' la, sold' mi, red'
  red, mi red mi fa mi fad mi red mi red mi fad mi red dod
  % 5 %
  \stemUp \mg si! si \md re' \mg red, \md fa' \mg fad, \md la' lad,
  re' do dod, re' mi, fa' sold, fa' \stemNeutral
  si, lad sold fad mi red dod si dod' lad sold fad red' sold, fad dod
  re' do la do red dod mi red re do sold do mi dod fa dod
  red sol, mi' fa si, do, do' dod sol la, sold' la mib lab, fab' sib,
  % 6 %
  \stemUp sol'! sib \mg fa, \md do' \md reb, \md la' \mg sib, \md fa'
  \mg solb, solb \md mi'? \mg mib, \md sib' \mg dob, \mg sol' \mg lab,
  \md \stemNeutral \clef bass \ottava #-1
  solb fa mib reb dob sib lab solb lab' solb fa dob sib' do, mib reb
  ...
  reb la solb lab reb, fa lab fa mib' sib lab sib fa' do solb do
  reb lab fa lab do, lab' fa lab dob solb reb solb la re, sol, re'
  ...
  mib sib lab sib lab sib lab sib fa' sib, sol sib sol' do, fa, sib
  ...
  la do, mib fad, dod fa la dod si' red, sol, red' dod' fa, la, fa'
  sib re, fad, re sib re sib' re do' mi, solb, mi' re' fad, sib, fad'
...
\relative do' {
  ...
  re sol, do, sol' do, la' do, sol' mi' fad, si, la' fad' si, sib, fa'
  \clef treble sol' re la re la' re, si' mi, dod' sol re' fad, red' mi, fad' re,
  % 3 %
  ...
  mi si sold si mi, sold si sold fad' dod si dod sold' red la dod
  mi si sold si sol si sold si fad' dod sold re' sold red sol, mi'
  ...
  \mg \stemUp sol, \md  \stemDown fad' \mg \stemUp si, \md \stemDown lad'
  \mg \stemNeutral sib, do sib do dod do re do sib do sib do dod do re do
  si lad sold fad mi red dod si dod' si lad sold red' lad sold fad
  lad si sol' lab re, solb, mib' fa si, dod, dod' re sol, sib, la' reb,
  % 6 %
  \clef bass \stemDown solb solb solb, mib' re,? dob' la,? lab'
  fa, sol? fa' do, reb' re, sib' do, \stemNeutral \ottava #-1
  fa, sol? fa sol lab fad la lab si lab sib lab lab solb lab fa
  solb lab sib dob reb mib fa solb lab, dob reb mib sib fa' solb lab
  \ottava #0 solb fa mib reb lab' solb sol si sib solb la sol do lab sib solb
  % 7 %
  reb' reb, reb' mib mib fa fa solb solb lab lab sib sib do do reb
  re, dod' sold la, re dod' la, sold' dod re, la sold' dod re, sold la,
  sib la' re mib, reb do' sol fad' mib mi, la \clef treble lab' solb sol, si' do,
  ...
  lab sib fa mi do' reb sol, fa mib' fa lab, sol sol' lab re, fad
