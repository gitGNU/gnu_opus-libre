...
\relative do' {
  ...
  \t 4 {
    \tupletsOff
    mi,8_( do' sold) mib_( si' sol) sib_( la sold) |
  }
  s2.*2
  \t 4 {
    mi8_( do' sol?) mib_( si' sold) sol fad fa |
  }
  s2.*2
  \t 4 {
    do8_( sold' mi) si_( sol' mib) reb do si |
  }
  ...
  \clef treble
  \t 4 {
    sol'''8_( mi dod si re fa)
    dod_( sib sol fa lab si)
    sol_( mi dod si re fa)
    \clef bass
    do_( la fad)
  } mib4-- r |
  \clef treble
  ...
  \t 4 {
    ...
    fa dod' la' la dod, fa,
    fa?( si fa') \stemUp si,_( la'
    \md \stemDown sol')
    \mg \stemNeutral la,_( fa' dod') |
  }
