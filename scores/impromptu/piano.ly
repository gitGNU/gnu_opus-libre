...
\relative do' {
  ...
  r <la do re mi sol> q q q q q |
  q q q q q q r |

  <sib do fa> q q q q q q |
  q q q q q q q |
  ...
  \ottava #1
  <fad fad' la>4. <sib sib'>8~ <sib sib'>4~ \t {sib8
  \ottava #0 <la, la'> <fad fad'>} <sib, sib'> <la la'>
  <fad fad'> <la' la'>4 <sib sib'>8
  \ottava #1
  <la' dod fad la>4. \ottava #0 <la, dod la'>8~ <la dod la'>4
  <sib sib'>2~ \t {<sib sib'>8 <la la'> <fad fad'>}
  <fa fa'> <dod dod'> |
  <la sib fa' la>2 fad'4 fa <dod re>2. |

  <do fa>4 q q q q q q |
  <do re fa> q q q q q q |
  <do re fa sol> q q q q q q |
  <si do re fa sol la> q q4. q q2*1/2\laissezVibrer
  s4\fermata | \hideNote q1*7/4\laissezVibrer

  la'4. sib8~ sib2.~ \t {sib4 sib, la} |
  la'4. sib8~ sib2. la4 fad |
  <do fa>4 q q q q q q |
  q q q <do mi> q q <do fa> |
  q q <do mi> q q <do fa> q |
  q <do mi> q q <do fa> q q |
  <do mi> q q q q q q |
  q q q q q q q\fermata |
}
