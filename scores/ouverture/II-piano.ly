...
PianoIIMd = \relative do' {
  <la si re>4->--\f\<
  <si dod re>->-- <la do re>->-- <sol do re>->-- R1
  <sol re'>16\sf <fad la mi'>~ <fad la mi'>2 |
  <la re>16\sf <do mi>8->( <re fad>->\<
  <mi la>-> <fad si>-> <la do>16->) |
  <si re>2->\! r8 |
  <sol, re'>16\sf <do mi>8->( <re fa>->\<
  <mi sol>-> <fa sib>-> <sol do>16->) |
  <sib re>4->\!~ <sib re>16 \mg
  <re,,,, re'> <re'' re'>-> <re, re'> \md |
  <fad' sold lad do re>4->-- <sol! lad si re>->--
  <fad la sib dod re>->-- |
  <fad sol re'>16\sf <la sib mi>4..->~ <la sib mi>4. |
  ...
  <re fad re'>16->\fff <mi sold mi'>4..-> \ottava #0
  \clef bass
  <fa,,,, sold si re mi>2\dyn "sfffz" \clef treble |

  s2 \pl {re''8-. sold-. re'-. sold-.}
  \lightBeams { \tt {re,32( \graceNotes {fad la do mi)}} s8
  \tt {re32( \graceNotes {fad la do mi)}} s8}
  \stemUp \ottava #1
  \mg \lightBeams {\tt {re32 \md \stemDown \graceNotes {fad la do mi}}
  \mg \stemUp s8 \tt {re32[ \md \stemDown \graceNotes {la' fad mi do]}}
  \mg \stemUp s8 \tt {re,32[ \md \stemDown \graceNotes {fad la do mi]}}
  \mg \stemUp s8 \tt {re32[ \md \stemDown \graceNotes {la' fad mi do]}}
  \mg \stemUp s8 \tt {re,32[ \md \stemDown \graceNotes {fad la do mi]}}
  \mg \stemUp s8 \tt {re32[ \md \stemDown \graceNotes {la' fad mi do]}} s8 |
  \mg \stemUp re,32[ \md \stemDown \graceNotes {do' la fad]}
  \mg \stemUp sold,[ \md \stemDown \graceNotes {fad' mib do]}
  \mg \stemUp dod,[ \md \stemDown \graceNotes {mib' do la]}
  \mg \stemUp sol,[ \md \stemDown \graceNotes {do' la fad]}}
  \ottava #0 s2 \stemNeutral |

  s2 \ottava #1 <sold' sold'>8-._\pp \ottava #0 s s4 | s2 |
  ...
  <sold'' sold'>8->-._\dyn "p_staccato" <red red'>16-. dod'-.
  ...
  <dod dod'>8-. <sold' sold'>-. |
  \ottava #0
  <mi,, sol re'>16->_\dyn "en dehors" <re la' mi'>8.
  r16 \ottava #1 <sold'' sold'>-. <red red'>-. dod'-. |
  <sold sold'>8-. \ottava #0
  \t {mi16-"loco"( la, re,)} s4 |
  \t {<mi, la re>8->( <fa sib mi> <sol do fa>~}
  <sol do fa> <la dod sol'>-.--) |
  ...
  <sold sold'>8-. \ottava #0
  <fad,, do' re fa!>---"loco"(\< <sold re' mi sol!>--) |

  <la la'>2*2\fff\laissezVibrer | s1 R1
  \stemDown <sib, sib'>32->_\ff
  \stemUp <do do'>4...->\laissezVibrer \stemNeutral
  s2\dyn "peu à peu plus souple" |
  la''2--\laissezVibrer
  \pl {<sib,, do la'>2~_\mf <sib do la'>\laissezVibrer
  \ottava #-1 la,2-- \ottava #0 }
  {\t {sib''8( do4~)} do~ do2*2\laissezVibrer } |
  R1 \bracketDown "m.s."
  <do, la>4--(\dyn "pp_très blanc" <la do>-- q-- q-- q-- q-- q--) |
  \bracketUp "m.d." <la do>--( \bracketDown "m.s." <do la>--
  <la do>-- q-- q-- q-- q--) | q--( q-- q-- q-- q-- q-- q--) |
  <sib' la'>4.--\pp \>\arpeggio sib8~( <sib la'>4--)\! r8 |

  <sib la'>2-.-- q-.-- q4.-.-- q-.-- | q q8~ q4 q~ q q2 |
  <si red>4--(\dyn "pp_sempre" <si red>2-- <do mi>4--)
  <si red>--( <si re>--) <si red>-- |
  <do mi>--( <si red>2.--)\laissezVibrer s2. |
  <sold sol'!>4.--\pp <la sold'>8(
  <sib la'>8.-- <si lad'>16--)~ <si lad'>8 |

  <lad red fad si>4--\p\laissezVibrer s2 \clef bass |
  R2. r4 <sol, mi'>(_\> <la red>)_\! <lad mi'>( <si red>) r |
  r <sib re mi>_\mp( <la dod red>) r <si dod mi>( <lad sid red>) |
  ...
  R1*5
  do4.--(\dyn "pp_simile" do-- do-- do--)\laissezVibrer | R2. R4.
  <si mi sold si>2--(\dyn "p_espr." <si mi sol do>--) |
  \pl {<si mi fad>-- mi4( red)}
  {do'( la) <si, fad' si>2--} \clef bass |

  \pl <fa la si>2.\dyn "f_sub., très intense"
  {re'16-> mi8.~ mi2}
  ...
  \t {<sib sib'>16->\dyncresc "poco cresc."
  <do do'>8. <mib mib'>4 <fa fa'>} |
  ...
  <re,, sol re'>16->\ff <mi la mi'>->~ <mi la mi'>4\laissezVibrer
  s4. r4 <mi mi'>(\ff |

  <re re'>16-.) re_\mf re re re re re re re re re re re re re re
  ...
  mi-. fa-.\dyncresc "poco a poco cresc."
  sol8--( re-.) mi16 fa sol re mi fa |
  ...
  mi8-. fa-. sol-- <re re'>16\<( <mi mi'>) r
  <fa fa'>8-.-- <sol sol'>16-.-- |
  \pl r2 <fad' la re>\f\laissezVibrer
  <re, sib'>8-. <mi do'>-. <fa reb'>-. <sol mib'>16( <re sib'>)
  r <mi do'>8( <fa reb'>16) <sol mib'>8-- r sib16( do reb mib) |
  \pl {s8\mp \cresc re,16 s re s re s} {re re re re re re re re}
  s4*5 s4*7
  <sol do fa>8-.--\f <la re sol>-.-- <sib mib lab>-.-- <do fa sib>-.--
  ...
  %s4*7*2
  %% Second version:
  <si mi la>->--\ff\laissezVibrer s s1 |
  %% (I wasn't sure whether to finish the crescendo with a chord
  %% or to leave it hanging, but C. H-R advised me to add this.)
  \mg \slurUp\stemUp sold,,,32( dod red sold sold dod \md red sold
  ...
  <fa fa'>^> <sold dod>16 <sol sol'>^>) <sold dod>8-.\! \slurNeutral
  \ottava #0 | %%%

  R2. <la,,, do>4.--(_\dyn "pp_dolce"
  <la do>-- q-- q-- q-- q-- |
  q2--)\laissezVibrer s4 |
  r <la do>2--\laissezVibrer -"simile" |
  s2.
  re16->\dyn "ff_sub." <mi, mi'>4..\laissezVibrer s4 s2.
  re'2.\startTrillSpan-"(ordin.)"_\pp _\< ~ re_\f _\<~
  \longHairpin re_\ff _\>~ re2_\pp\stopTrillSpan |
  s1*2
  <re re'>4-> r16 <mi mi'>8.-> <re re'>4-> r16 <mi mi'>8.-> <re re'>4-> |
  <re re'>16-> <mi mi'>8.~ <mi mi'>2
  \longHairpin \hairpinText "molto" re2*1/2_\p_\<\startTrillSpan s8 s |
  <re mi>4_\dyn "sffz"\laissezVibrer \stopTrillSpan s4. |
  \clef bass <re, fad re'>16->\ff <mi la mi'>8
  ...
  solb' mib reb dob lab\dyncresc "cresc. sempre" dob reb mib
  ...
  \mg \ottava #-1
  \t {<la,,,, la'>16(\dyn "ff_al fine"\< \ottava #0 \graceNotes {mi''' si'}}
  ...
  r <mib sol mib'>8-- <sib re sib'>16-.(
  <do mi do'>8-.) <reb fa reb'>-.
  <mib sol mib'>-- <sib re sib'>16-.( <do mi do'>-. |
  <reb fa reb'>8-.) <mib mib'>16-> <sib sib'>-.(
  <do mi do'>-. <reb fa reb'>-. <mib sol mib'>8-.)
  <sib re sib'>8.--( <do mi do'>16--~
  <do mi do'>8 <mib sol mib'>--) |
  <dod dod'>16-.( <red red'>8-.) <mi mi'>16-.
  r <fad fad'>8-- <dod dod'>16-.(
  <red red'>-. <mi mi'>-.) <fad fad'>8--
  <dod dod'>16-.( <red red'>-. <mi mi'>-. <fad fad'>-.) |
  <dod dod'>-._\< <red red'>-. <mi mi'>-. <fad fad'>-.
  <sold sold'>8--_\! <dod, dod'>16-._\< <red red'>-.
  <mi mi'>-. <fad fad'>-. <sold sold'>8--_\!
  <dod, dod'>16-._\< <red red'>-. <mi mi'>-. <fad fad'>-. |
  <sold sold'>8--_\! <dod, do'>16-._\< <red red'>-.
  <mi mi'>-. <fad fad'>-. <sold sold'>-. <la la'>-.
  <lad lad'>-. <si si'>-. <do do'>-. <do do'>-._\! | \ottava #0
  \clef bass R2 |
  <re,,,, mi la re>4->--\f <re mi sold si re>->-- |
...
PianoIIMg = \relative do' {
  ...
  <re mi la si re mi>16\sf <mi,, mi'>8.->~ <mi mi'>2
  r8 <re re'>16-> re'' |
  ...
  \lightBeams {\tt {re,32_\dyn "pp_subito"(
  \graceNotes {fad la do mi)}} s8
  \tt {re32( \graceNotes {fad la do mi)}} s8}
  s2 \clef treble \ottava #1
  re''8-. sold-. re'-. sold,-. re-. sold-. re'-. sold,-. |
  re-. sold-. re'-. sold,-. | \ottava #0
  re8-.-"loco" sold,-. dod,-. sol-.
  ...
  \lightBeams {
  \t {re,\f( \graceNotes {la' mi')}} \md \graceNotes \t {mi'( \mg la, re,)}
  ...
  \mg \clef treble
  <mi,,, sol do re>16->_\dyn "f_en dehors" <re la' mi'>4..--
  <mi sol la mi'>2-- |
  <mi sol do re>16-> <fa sib mi>8.--
  <mi la fa'>16-> <re sol mi'>2-- <fa sib do>8. |
  \clef bass
  ...
  \t {re, \mg mi la,)} \clef bass |
  <re,, re'>8-- <do do'>--
  \t {<si si'>--( <sib sib'>-- <sold sold'>--)} |
  ...
  \pl la la''1*1/2^\f--\laissezVibrer
  la,,2~ la la_\dyn "(mp_sempre)" |
  <la la'>4 la2. | la4 la2*1/2 s4_\> la4 |
  <la la'>2*2\pp _\!\laissezVibrer \ottava #0 s1 s2. |
  \ottava #-1 <la la'>2*2_\ppp\laissezVibrer \ottava #0 s2. s1 s2. |
  \clef treble <la''' do>4--( <la do>-- <la do>--) r8 |
  \longHairpins {\hairpinText "(poco)"
  <la do>4--_\> <la do>_\! <la do>--_\> <la do>_\! <la do>--_\> <la do> <la do>_\!
  <la do>--_\> <la do> <la do>_\! <la do>--_\> <la do>_\! <la do>--_\> <la do>_\! }
  \pl {lab2-.-- lab-.-- lab4.-.-- lab-.-- lab2*2--\laissezVibrer}
  {<mi' sol>4--( <mi sol>2-- <red fad>4--)
  <mi sol>--( <fad sol>--) <mi sol>--
  <red fad>--( <re sol>2.--)} s2.
  <la do>8-> <la do> <la do>-> <la do> <la dod>( <sib re> <si red>)

  <sold do mi>4--\laissezVibrer s2 \clef bass
  R2. \ottava #-1
  <sold,, fadd'>4*3\dyn "f_ample" \laissezVibrer
  <dodd, red'>\laissezVibrer
  ...
  \t {\hairpinText "molto" mi32\> re la)} \ottava #0
  ...
  \ottava #0
  <mi' mi'>8_"loco"_\sfz <dod dod'>16\dyn "mf_staccato"
  <dod' dod'> <si, si'> <si' si'> |
  ...
  <mi, mi'> <sib'' sib'>^> <sol, sol'>\cresc <sol' sol'> <fa, fa'> <fa' fa'> |
  <mi, mi'>_\< <si'' si'>^> <la, la'> <la' la'> <fad, fad'> <fad' fad'> |
  <mi, mi'>4_\!\f s |
  <re' sib' re>16-> <mi do' mi>->~ <mi do' mi>4\laissezVibrer
  \pl {\ottava #-1 <mi, si' re>4.}
  <fa' sold si re mi>_\dyn "sfffz" \ottava #0 r4 <mi mi'>( |
  ...
  <re re'>4*1/2->_\dyn "en dehors"
  re'16 s <mi, mi'>4-> <fa fa'>-> <sol sol'>->
  <re re'> <mi mi'> <fa fa'> <sol sol'> }
  ...
  \lightBeams {
  \t {mi16(\p\< \graceNotes {la re}} \graceNotes {mi32 fa sib re)
  ...
  mi''32*8\f \> \ottava #0 \graceNotes {
  \t {re,16( sib fa} mi32 re la mi)
  \t {re'16( sib fa} mi32 \mg re la mi\!)
  \t {re'16( sib fa} mi32 re la mi)}}
  \ottava #-1
  <re, re'>4->\f \cresc r16 <mi mi'>8.-> <re re'>4-> r16 <mi mi'>8.-> r16 <mi mi'>8.-> |
  \ottava #0 <re' re'>16->\ff -"loco" <mi mi'>8.~ <mi mi'>1 |
  <mi, mi'>2\laissezVibrer s8 |
  mi'4._"loco" mi8 mi | <mi, mi'>2\laissezVibrer s8 |
  ...
  <mi,, mi'>->_\mf \graceNotes {la''32( do re mi}}
  sol16) <fad,, fad'>8.->_"en dehors" | \lightBeams {
  ...
  %% This \ottava might not be needed, but let's play it safe anyways.
  ...
  R2
  <fad,,, fad'>4->--_"(sopra)" <fa fa'>->-- <mib mib'>->-- <do do'>->-- |
  <sib sib'>->-- r2 | s2.^\fff \ottava #-1 la,4^\dyn "sfffz"\colpugno \ottava #0
}
