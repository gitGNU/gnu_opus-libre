...
\relative do' {
  ...
  \clef treble
  \key la \minor
  mi8~\p <mi si'>4 fa8~ <fa do'>2
  mi8~ <mi si'>4 <fa do'>8--~ q2
  <mi si'>4.-- <fa do'>8--~ q2
  <mi si'>4.-- <fa do'>8--~ q2
  <mi si'>8(-.\cresc mi-.) si-. <fa' do'>8--~
  q mi-. sib16-> sib sib sib
  <mi si'>8( si) <fad' dod'>8-- <fa do'>4-- <mib sib'>8-.
  <re la'>16-> <dod sold'> <do sol'> <si fad'>
  \clef bass
  <si, mi>8\f r r4 \clef treble
  r8 la'''( \t {sol)\< re( do)}
  re2~\! \t {re8 la'( sol)}
  \tt {re16( la') sol( re do)}
  re2. sol16( fa) do sib
  do8( fad) \t {mi( si) la~\>} la8 si4.~\!
  si4 la'\> \t {si( mi fad)} mi2.\p r4
  \clef bass
  <la,,,, si mi>8->\f\arpeggio la'-. <si, mi>-.\downbow
  ...
  <si mi>(\mf la) <si mi>-. <do fa>4-- mi,8 <do' fa>-- mi,-.
  <si' mi>( la) <si mi>-. <do fa>4(-- mi,8) <do' fa>(-. <lad red>-.)
  <si mi>( mi,) <si' mi>-. <do fa>4--
  <dod fad>8\cresc <re sol> <red sold>
  \clef tenor
  <mi si'>(-- <mi, la>--) <mi' si'>-. <fa do'>(--~
  \t {do'4 re) red}
  \clef treble
  mi4.\f fa8~ fa2~ fa8 mi4(\< fa4\! mi8) \t {fa( si do)}
  si4. do8 \t {si4( mi si~}
  si) r8 do\upbow \t 4 {sib(\> fa mib) mi( si la)}
  mi4\! r8 do\upbow \t {re sol( la)} sol mi'16( re)
  la( sol) la4. r8 mi\upbow fa16( sol) do( re)
  do4. fa,8 mib16( fa) sib( do) reb,( mib) lab( sib)
  \clef tenor
  lab,\cresc( sib) fa'( sol) fad,( sold) mib'( fa)
  mi8(-- sol--) \t {fad(-- fa-- mi--)}
  <>\f
  <<
    {
      ...
      \down <si,, mi> \up
      <lab'' mib'>16\downbow q q-> q q8-.
      \down <mi, la>-- \up <sol' re'>-.
      \down <mi, la>-. \up
      <lab' mib'>4--\downbow
      <sol re'>8-. <lab mib'>16-> q <la mi'>8-.
      \down <mi, la>^\ff \up <sib'' fa'>
      \down <mi,, la>16-. q-.
      \up <si'' fad'>8->
      ...
      <mi si'>->\!\upbow \down <si,, mi> <mi la>
      \up <fa'' do'>4->--
      \down <fad,,, si>16^\upbow\dim q
      <si mi> q <mi la>8-.
      \up <mi'' si'>4-- \down <mi,, la>8-.\downbow
      \up <fa'' do'>~ q2
      \showStaffSwitch
      \down <> \clef treble
    }
  ...
  >>
  <mi si'>4.--\mf <fa do'>8(--~ q4 mi'--~)
  mi8 <mi, si'>4--\> <fa do'>8--~ q2\!
  <mi si'>4.\dim <fa do'>8~ q2
  <mi si'>4.( <fa do'>8~ q4) r
  <mi, si'>4.\p <fa do'>8~ q2
  \clef bass
  r8 <mi, si'>4\upbow <fa do'>8~ q4. <si, mi>8-.
  <si mi>8-. r r4 \clef treble
  r8 la'''(\mp\upbow \t {sol re do)}
  re2(~ re8 la') \t {sol( do,) re~}
  re fad \t {mi16( si la~} la4) si8~ si4~
  si8 la\downbow \t {si(\> mi fad)}
  si,4.\! \clef bass mi,,8 \t {fad si( dod)}
  si,2.~\p si4 r
  <lad si>4-.--\f <mi' mi'\harmonic>->\sfz
  \bar "|."
}
...
MiPianoMd = \relative do' {
  ...
  \clef bass
  <si mi>4.(\dim <fa do'>8~) q2
  <mi si'>4.( <do fa>8~) q2 \clef treble
  r8\p \t {si'16 si si} si4-.
  ...
  r8 do do4 r do
  r do r2 \xNotesOff
  r \tt {r16 mi'(\f fa si do} <mi, mi'>8-.->) r
}
