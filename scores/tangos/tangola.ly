...
LaPianoMd = \relative do' {
  ...
  <sold re'>\! R1
  \clef treble
  mib'16(\p re mib4) mib8~--( mib re) re4
  re4.-- r8 r2
  ...
  <sold dodd>8(-- red' dodd) <sold red'>~(--
  q dodd) sold'( dod,)
  <sold re'>4-- q2-- r4
  r8 <mi' do' mi>4.--\mf\< r8 <fa do' fa>4.--
  ...
  q <fa la do fa>4.~) q2
  r4 \ottava #1 la''8(\mp do,) fa-. mib4.--
  r2 r4 <red la' red>8-.\sf r
}
...
LaPianoMg = \relative do' {
  ...
  la,_"simile" la' si, si' do, do' si, si'
  la, la' sol, sol' fa, fa' mi, mi'
