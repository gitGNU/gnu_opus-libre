...
\relative do' {
  ...
  <re' fa sol dod>^>^-^( \dyn "sempre_f"
  sib, <re' dod'>^.) la^"meno legato" <fad do'> la |
  ...
  s <la' do>[_(_\p <sold si>]) \tupletsOff s s <la si>-. |
  ...
  \t {
  la8->-. fad-. mib-. do-. la-. fad-.
  mib-. do-. la-. fad-. do-. fad-. |
  ...
  \tupletsOn
  r <reb do'>^. re'^. r \longHairpin <mib, dod'>^.\< red'^. | \tupletsOff
  ...
  %%% 3x7 %%%
  \clef bass r16\dyn "p_legato leggiero"
  \slurDashed lad,(\( si) la( lad si) sol( sold |
  la sib) mi,( fa fad sold la) \ottava #-1 do,( |
  dod red mi fad sold) lad,( si do re[ r fa sol])\) |
  \slurSolid
  fad-- si,( do) si( do dod) lad( si dod re) lad( si |
  dod re red) la^"simile" sib si do la |
  si do re mi la, sib fa' lab, |
  fad'8 \ottava #0 r r <mib' fa>-.^"loco" |
  r r16 <si la'>-. r8 r16 <mib fa>-. |
  r8 <la si>-- <mib fa>16-. <la si>8-- mib16-.
  r8 <si' fa'>-.\sfp | \slurDashed
  la16(\( sold) la( sold sol) lab( sol fad fa) sol fad fa |
  \slurSolid mi mib\) solb( fa mi mib re reb |
  sib sol mi dod \ottava #-1 red si sol red) \ottava #0 |
  r4 r8 r16 do'--\laissezVibrer \clef treble |
  r4 r8 \ottava #1 <re'''' dod'>--_\mf ~
  <re dod'>16 <re dod'>8.--
  <si lad'>8--( <do si'>-- <re dod'>4--) |
  \ottava #0 fad,,8-.-- r fad16(_\< sol)_\!
  r8 fad16(_\< sol sold)_\! r |
  la( sib <re dod'>8)-. r16 <re dod'>8.-- |
  <si lad'>16-. sid'-. <re, dod'>4.--\cresc |
  r16 <mib lab sib re>8.->--(
  <mib sol la re>8-.) <do si'>16-. do'-. |
  <re, fad sold dod>8.-- <mib lab sib re>16->--~
  <mib lab sib re> dod'-. <mib, re'>8--\! r16
  <si lad'>(-.\< sid'-. <re, sol la dod>-.)\! |
  r8 \ottava #1 <mi red'>16-.\< mid'-.
  <sol, fad'>-. <re' re'>8.->-- |
  ...
  \tupletsOn
  <mi sold si>4^>^-( \ottava #1 <sib' la'>8^.^\dyn "poco più")
  r <sol fad'>^. sold'^. |
  \tupletsOff
  ...
  \tupletsOff mib-.\dyn "(pp)" do-. la-. fad-. mib-. do-. |
  ...
  \mg \stemUp si \md \stemNeutral <mib sol sib do>^(_\<
  <fa la si mi>)_\! |
  \tupletsOn
  ...
  \set tupletSpannerDuration = #(ly:make-moment 1 4)
  \t {
  r8 <dod fa>[_( <do mi>)] \tupletsOff s s <do mi>_. | \tupletsOn
  r <sol' si>[_( <fad sib>)] \tupletsOff s s <fad sib>_. | \tupletsOn
  r <re' fa>[_( <dod mi>)] \tupletsOff s s <do mib>-. | \tupletsOn
  s <si re>[_( <fa' sold>)] \tupletsOff } \stemNeutral r4
  \t {
  fad,,,8-. la-. do-. mib-. sol-. sib-.
  dod-. mi-. sol-. sib-. dod-. fa-.
  ...
  <mib, solb sib>^-^ . fa^-^. \mg <lab,, dob mib>^-^.
  la^.^( <dod mi sold>^. dod'^. |
  \md <mi sol si>^.) \mg mi,^.^( \md <sol sib re>^.
  sol'^. <si re fad>^. do'^.) |
  \ottava #1
  <mib lab sib re>^>^-^(_\ff _\< re <mib lab sib re>
  dod^>^- <mi fad la dod> dod
  <do fa sol si>^>^-)_\! \ottava #0 si, <do fa sol si> \tupletsOn
  \stemNeutral r \stemUp <la, dod mi>[_._(
  \mg <mi sold si>_.)] \tupletsOff
  dod \md <dod' mid sold>_. \mg la \md <lab' do mib>-.( <sib re fa>-.) s |
  \ottava #1
  <mib' lab sib re>^>^-^(_\ff_\< re <mib lab sib re>
  dod^>^- <mi fad la dod> dod |
  <do fa sol si>^>^- si <do fa sol si>
  lad^>^- <dod red fad lad> lad |
  \tupletsOn \ottava #0 \stemNeutral \tupletUp
  <la re mi sold>4^>^-)_\dyn "sffz"
  \stemUp <la, re mi sold>8 \tupletNeutral \tupletsOff
  mi <mi sold la re> \mg la, \md |
  <la' si mi fa>[ la]
  <sib' do mib sol>[^-^(_\< sol <sib,, do mib sol> sol'']) |
  <la re mi sold>^>^-_\! sold, <la re mi sold>
  \stemNeutral r \mg \stemUp <la,, re mi sold> \md mi'' |
  <la re mi sold>[ sold <la re mi sold> mi'']
  <sib do mib sol>[^-^( sol] |
  <fa, sol sib> mi \mg <do, re fa> do' \md <mi fad la> la') |
  <re mi sold>^>^-^(_\ff_\< sold, <la re mi sold>
  sol^>^- <sib do mib sol> sol |
  \tupletsOn \stemNeutral <fa la si mi>4^>^-)_\!
  \stemUp <fa la si mi>8 \tupletsOff mi <fa la si mi> mi |
  <fa la si re mi> sol, <fa la si mi> \mg si,^(
  \md <do re sol la> \mg si | \md
  <do re mi fa> re' <mi fa sol la si>)
  sold'^- <la,, re mi sold> reb' |
  <si mi sol>[_(^- sol <sib, do mib> lab <re fad la> \mg sol,,)] | \md
  \tupletsOn \stemNeutral <la'' dod mi>4--\fff\> \stemUp <la dod mi>8^(
...
\relative do {
  ...
  \tupletsOff
  s mi_-_\laissezVibrer s <sold do> s <sold do> |
  \mg s mi,_-_\laissezVibrer s \md <dod' fa la> s <dod fa la> |
  ...
  \t {
  <sol''' si red>8 s <sol si red> |
  s mi_-_\laissezVibrer s <fad sib re> s <fad sib re> |
  \mg s mi,_-_\laissezVibrer s \md <la dod fa> s <la dod fa> |
  ...
  \mg s8 <mi, red'> s <fa, mi'>_-\laissezVibrer s <la' si> |
  s <mi red'>-.-- s \stemNeutral
  \tupletsOn <re dod'>-.-- r fad,, |
  <fa' mi'>->-. r red''->-. r mi,-. fa,-. |
  \tupletsOff
  fad,-._( dod'-. re'-. \stemUp red'-.)
  ...
  <fa, mib'>^>^\ff mib' <fa, mib'>^> la <fa mib'>^> la |
  ...
  \t {
  <fa mib'>8^>^\mf lab <fa mib'> la <fa mib'> la
  ...
  <re do'>-. r <mi sold>-. r |
  <si' sold'>-. r <sol mib'>-. r |
  \clef treble <reb' lab'>\cresc r <la' mib'> r |
  <fa' sib> r <si red> r |
  \t {
  ...
  \mg s <sib, la'> s <sol fad'>[_- s <mi red'>] |
  \tupletsOn r <solb fa'>4_-\laissezVibrer r8 <re dod'>4_- |
  }
  \stemNeutral <sib la'>4-- \laissezVibrer <sol' fad'>-- \laissezVibrer |
  \t { \stemDown r8 <si lad'>4 } \stemNeutral <sol fad'>-- \laissezVibrer |
  \t { \stemDown r8 <si lad'>4 \stemNeutral
  <sol fad'>-- \laissezVibrer <si lad'>8}
  <sol fad'>4-- \t {r8 <mib re'>4}
  \set tupletSpannerDuration = #'()
  \t {<si' lad'>8 fad' <mib, re'>4-- <mib' re'>--}
  \set tupletSpannerDuration = #(ly:make-moment 1 4)
  \mg <la, la'>8->-.\sfp r \acciaccatura {mi'16[ fad]}
  \t { \tupletsOff
  sold8-._( fa-. re-. si-. sol-. mi-.
  \clef bass dod-. sib-. fa?-. |
  \tupletsOn fad,-.) r \clef treble si''-._( \tupletsOff
  ...
  fad16-- _"loco" \slurDashed fad'(_\(
  sol) fad( sol lab) sol( sold |
  la\dyn "p_sempre" sib) sol( sold la lad si) sold |
  \slurSolid
  la lad si do dod sold la lad si do dod re |
  mib4\) r8 <fad,, mi'>-. r r16 <fad mi'>-. |
  \clef treble r8 r16 <red'''' dod'>-._\dyn "mp_(sopra)"
  r <sol la>_( <red dod'>8->) |
  <mi, fad>-. r16 \clef bass <do, sib'>-. r8 r16 <mi, fad>-. |
  \ottava #-1 do,->\p do'( dod) do_( dod re fad sol \ottava #0
  sold_"loco" la) fad_( sol sold la sib do |
  ...
  \ottava #-1 sold la) do,( dod re red mi)
  fad,( sol sold la lad |
  ...
  <la, si'>^> \ottava #0 s <mi''' red'>_. s <fa, sol'>_- s |
  s s <mib' fa'>_. s <la, mi' sol>_- s |
  s <sib sib'>_. s <do fad si>_. s s \stemNeutral \tupletsOn |
  <lab, sol'>_. \ottava #-1 r <mib fa>_\f_(
  <la, si'>) \ottava #0 r <re'' do'>_._\p |
  r <mi, fad'>_( <lad dod> <sold mid'>) r <sol' mib'>_. |
  r fad,_._( sold'_.) r <lab, do re sol>-. r |
  \tupletDown r <mib solb sib reb>-. r
  \tupletNeutral \stemDown r mi_.^( fa,_.)
  } | \tupletsOn \stemNeutral
  \ottava #-1 <la, si'>^>^\dyn sffz \ottava #0 r
  ...
  \ottava #-1 la,,,-.\p do-. mib-. dod-. mi-. sol-. \ottava #0
  sib-.\dyncresc "cresc. molto"
  re-. fa-. fad-. la-. do-. re-. fa-. lab-. |
  ...
  r32 <sib,,,, sib'>4...*7/15->--^\sf \laissezVibrer
  \md \stemDown \t {
  ...
  <sib,,, sib'>4->--^\sf\laissezVibrer \ottava #0 s8 | \stemDown
  <fad'' lad dod>_-_. s <re' fad la>_. s s \md <mib'' sol sib>_. |
  s <mib lab sib re> s <mi fad la dod> s <mi fad la dod>
  ...
  %%% Coda %%%
  R2*6 r4*3/4 s16_"quasi niente" \ottava #-1 \md r4
}
