...
Flute = \relative do' {
  ...
  %%% 1 %%%
  mi2.~^"(non vib.)" mi8 redsd mi2 |
  re!4\glissando -"gliss." mi2~ | mi r4 |
  \t {re16 mi re} \tt {mi32 re mi re mi}
  \pitchedTrill re4.\startTrillSpan mibsb r8\stopTrillSpan |
  \tt {sol16 re mi sol fad} \acciaccatura sol fad4\startTrillSpan~
  ...
  \tt {mib16 re mib re mib} re4 r |

  %%% 2 %%%
  r \t {sol16 la mi} fad8~ fad4~ |
  fad4. solsb8 fad4~ |
  ...
  si16 la\glissando do fa, si4.\glissando mi,8 |
  r4 r8 \t {sol16 la re,} mi4~ |
  ...
  sol4~ sol16 lasb32 sol la8~ la4~ | la8 r r2 |
  r2 sol4~ | sol16 sol32 lab sol8~ \ttt {sol16 la sol la sol la} \ttt {sol mi re mi sol la} |
  sol2~\startTrillSpan sol8\stopTrillSpan \t {sol16 la re,} |
  mi8 re32 mi re mi re2~\startTrillSpan | re8\stopTrillSpan r r2 |
