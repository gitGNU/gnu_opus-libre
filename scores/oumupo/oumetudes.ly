...
\markup \center-column {
  \vspace #10
  \fill-line {"" \smaller \italic \right-column {
      "Ces pièces furent créées le 7 juin 2012"
      "au Grand Auditorium de la Bibliothèque Nationale de France,"
      "par Ayumi Mori, Jean-Yves Gratius et Florestan Boutin."
    }
  }
  \vspace #10
  \fill-line {
    ""
    \general-align #Y #0.5 {\epsfile #X #30 #"oumupo.eps" }
    \line {
...
\score {
\new StaffGroup <<
\new Staff \transpose re do \gammesUp
\new Dynamics \gammesDyn
\new Staff
\transpose re do \gammesDown
>>
\header { piece = "[gammes]" instrument = "(deux clarinettes)" }
...
\new PianoStaff <<
  ...
  \new Staff = "down" \clef treble
      {
        \autochangeWithPitch si' \un
        \deuxMg
        \autochangeWithPitch si' \trois \bar "|."
      }
  >>
