...
burgerPianoMd = \relative do' {
  ...
  r <sol re'> <la mi'> <si fad'> r <do sol'> <re la'> <red lad'>
  <mi si'>8 r r4\fermata
  r16 <mi si'> q q r q q q
  ...
  \clef treble
  r16 <re'' la'> q \mg \clef treble <do, sol'> \md <do' sol'> q
  ...
  r <sib' fa'> <la mi'> <sib fa'> r <mib, sib'> <mi si'> <sol re'>
  r <sib fa'> <la mi'> <sib fa'> r <la mi'> <sol re'> <fa do'>
  r <sold red'> <fad dod'> <mi si'> r <mi si'> <mib sib'> <re la'>
  <do sol'> <si fad'> r8 r4
  s1*5/8*3
}

burgerPianoMg = \relative do' {
  <mi si'>16 \md <mi' si'> q \mg <re, la'> \md <re' la'> q
  \mg <sol, re'> \md <sol' re'> \mg <la, mi'> \md <la' mi'>
  \mg <mi, si'> \md <mi' si'> q \mg <re, la'> \md <re' la'> q
  \mg <lab, mib'> \md <lab' mib'> \mg <sib, fa'> \md <sib' fa'>
  \mg \clef bass <mi,, si'> \md <mi' si'> q \mg <mi, si'> \md <mi' si'> q
  \mg <sib, fa'> \md <sib' fa'>
  \mg <mi,, si'> \md <mi'' si'> q \mg <mi,, si'> \md <mi'' si'> q
  \mg <mi, si'> \md <mi' si'>
  \mg <mi,, si'>8 r q r <sib' fa'> r q r
  ...
  <re la'> r <lab' mib'> r <re, la'> r <lab' mib'> r
  <re, la'> r <lab' mib'> r <re la'> r <sib fa'> r
  <mi, si'> r <sib' fa'> r <mi, si'> r <sib' fa'> r
  \md <la' mi'>16 \mg <do, sol'> q \md <la' mi'> \mg <do, sol'> q
  \md <la' mi'> \mg <do, sol'>
  ...
  \md <re' la'> \mg <do, sol'>
  \md <mi' si'> \mg <do, sol'> q \md <do' sol'> \mg <do, sol'> q
  \md <mi' si'> \mg <do, sol'>
  ...
  <fa, do'>8 r <si fad'> r <fa do'> r <si fad'> r
  <fa do'> r <fad dod'> r <si fad'> r r4\fermata
  <mi, si'>8 r <do' sol'> r <sol re'> r <la mi'> r
  <mi si'> r q r q r q r
  <si fad'> r <fa' do'> r <si, fad'> r <fa' do'> r
  <do' sol'> r <sol re'> r <do sol'> r <si fad'> r
  <mi, si'> r q r q r q r
...
burgerVoix = \relative do' {
  ...
  R1*5/8*2
  \time 4/4
  r2 r4 r8 si16 sold' reb'4 reb8 sib do do16 lab
  sib sib sol lab r8 lab r sol r fa sol16 sib mib mib re4 do8 sib16 lab sol8 fa
  sol16 sib mib re dod8 si si16 sold sold sold red red red8 r
  re16 re \tuplet 3/2 4 {re'8 dod si sold sold red} red16 re re re dod8 si16
  mi re8 dod16 dod mi la sold fad mi8 re16 dod si mi re dod dod8 r16 mi la
  lab re8 re16 fa, fa reb' reb8 fa,16 fa do' do fa,8 fa
  do'16 do fa,8 fa \tuplet 3/2 {r reb' re} sol,16 sold sold sold sold sold sold sold
  sol sol sol sol sol sol sol re' mi8 sol, \tuplet 3/2 {r8 do re} sib16 sol re'8 r4 do r8 re \tuplet 3/2 {mi4
  sol, sol} sol sol8 sol re'4 r8 mi r sol, do4 r8 re4 r8 sib4 sol8. re'16 do4 re8 r \tuplet 3/2 {r mi
  mi,} red red do'16 la8 sib16 fa?8 mi16 re
  fa la sol si \tuplet 3/2 {do8 si mi} r8\fermata si \tuplet 3/2 4 {la8 sol fad} mi fad \tuplet 3/2 {sol mi
  si'} red fad, \tuplet 3/2 {mi fad sol} mi4 red8 dod la'16 fad8 mi16 fad sol8 mi16
  mi red r8 r4 r8 do' la sib16 fa mi8. re16
  fa la sol8 si16 do si mi si8 la16 sol fad mi fad8 sol16 mi
  si' red fad,8 mi16 fad sol8. mi16
  \bar "||"
  sib'8. sol16 solb4 r8 fa mib4 \tuplet 3/2 {mib solb sib} r dob
  \time 5/8
  fa,4.~ fa4~ fa4.~ fa4~
  fa4.~ fa4~
  \time 4/4
  fa2. lab8 do fa2~ fa~ fa4 re8 re
  \tuplet 3/2 {mi dod la} re r16 mi \tuplet 3/2 {dod8 re mi} dod la re4 r8 mi \tuplet 3/2 4 {dod fad dod
  si dod re} dod8 fad,16 fad' dod si dod re dod fad,
  reb reb reb reb reb reb reb reb reb8 lab' sol lab16 lab sib8 \tuplet 3/2 {r8 dob dob}
  sol lab sib16 sib dob8 r reb \acciaccatura mib do16 \xNotesOn fa, fa \xNotesOff
  reb' \acciaccatura mib do8 sib lab16 do sib lab solb8 fa mib
  dob' sib8 r r lab
  \time 5/8
  solb8 r16 fa r8 mib
...
burgerTexte = \lyricmode {
  ...
  l’a -- ci -- de di -- a -- ce -- tyl -- tar -- tri -- que
  et d’a -- ci -- des gras...
...
\new Staff \relative do' {
  ...
  r4 <do fa lab> <fa lab do> <fad la re>2 <fa lab reb>4
...
cocaVoix = \relative do' {
  ...
  fadd sold lad si fadd r8 sold lad4 fadd sold
  lad si8 r dod8. red16 mi4~ mi si sol lad si r8 dod mi lad, si4
  r8 mi sib4 dob8 r lab solb fad4. mib8 reb4~ reb8
  mib do8 r mib fab reb4 reb mib do r8 mib fab4 r8 reb
  reb'4 reb r lab' la~ la4. fa8 do4
  si4. lad8 sold fad dod'4 r8 lad8 dod
  si la sold fad la re4~ re mib
  do~ do fa la, lab sol fa mib4. fa8 sol4~ sol4.
  mi8 fa4~ fa2 r4 r2 do4
  \bar "||"
  mi8 si' fad4. mi8 si' sold mi4 si' la mi8 si' sold mi si' fad
  mi4 si'8 sold mi si' la mi si' sold mi si' fad mi si' sold mi
  si' la mi si' sold mi si' fad r mi4 si''4. sold
  fa4 lab,8 lab' lab, lab' fa4 lab,8 do sib mib lab fa lab, do sib mib lab4 fa
  r8 lab, lab' fa lab, do sib mib lab fa lab, do sib mib lab2 r4 fa lab,8
  sold' fad4~ fad4 mi8 re si mi~
  mi8 mi,4 fad8 mi si' sold4 r mi8 si' la4 mi r8 si'
  sold4 mi si'8 fad mi4 si' sold mi si'8 la mi si' sold4 mi si' fad mi
  fad'~ fad4. mi8 re4 r si4. mi8~ mi4 mi, r r fad8
  mi si'4 sold mi8 si' r la mi si' sold mi si' fad mi si' sold mi
  si' la mi si' sold mi si' fad mi4 r2
  \bar "|."
}
