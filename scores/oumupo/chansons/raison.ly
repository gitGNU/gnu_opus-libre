...
\relative do' {
  ...
  fa'8 fa16 mib~ mib re8 fa16~ fa8 re mib4 r8 sib |
...
\relative do' {
  ...
  \repeat unfold 5 {
    re8._"D-" re16 la' <re fa>8.~ <re fa>8
    sol,_"G" re'8. <si sol'>16~ <si sol'>8 sol
  } \bar "||"
  \repeat unfold 5 {
    mib8._\markup {E \flat -} mib16
    sib' <mib solb>8.~ <mib solb>8
    lab,_\markup {A \flat -} mib'8.
