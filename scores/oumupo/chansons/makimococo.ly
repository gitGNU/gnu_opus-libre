...
\relative do' {
  ...
  re8 mib re sib lab | sol2 <sib' mib>8 <re sol>4 <do fa>8
  ...
  <si, do mi si'>4.\arpeggio si'4 lad8 si4
  ...
  r8 fa' solb lab |
  sib4. mib,8~ mib2. r8 sib'~ sib4 |
  la4 do8 sold4 re8~ re2 r8 mi'~ mi4 |
  red8 sold, dod, si' mi, la, sold' dod, fad, mi' la, re, sib si |
  do4 re8 mib sol sib, mib <la, do re fa>4 re8 mib fa mib re |
