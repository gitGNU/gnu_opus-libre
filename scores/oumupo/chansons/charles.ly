...
\relative do' {
  ...
  re4. fa,8 re'4 mi,8 lad fad'2. r4

  re4. re8 fad,2 r4 fad \times 2/3 {re' fad, re'}
  ...
  lab'4. do,8 lab'2~ lab4 do,8 do4 do8 do lab'~
  lab4 sol2.~ sol2 r
  solb2.\glissando la,4 la la2 solb'4 fa2. r4
  r solb,8 solb mib'4 fad,8 fad re'2
  r8 fad, fad fad re'4. sol,8
  mi'4. lad,8 fad'4 fad, r2
  re'2 dod4 mi, si' r r r
  fad2 r4 r8 sol si,4 r r2
}
...
CharlesTrempette = \transpose si la
  ...
  fad2 r
  r4 fa2.~\pp fa2( sol4 fa mi8) r fad( sol
  la sol fad mi) sol2~
  \times 2/3 {sol4 lab(\< sib}
  do2.)\mp r4
