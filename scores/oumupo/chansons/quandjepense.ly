...
\relative do' {
  ...
  \pl <la sib re>4. \times 6/4 {r16 la' sib re}
  ...
  {\times 6/4 {re'16 mib fa sol} lab8. sol fa fad sol4}
  re16 sol do, mib fa lab \times 2/3 {sib do re} |
  <mib, lab mib'>4. re'8. do |
  sib8 sol re do8. sib
  <sib, do mib>2.
  ...
  << { \voiceTwo
    ...
    <lab dob mib sol>4.--~ <lab dob re sol>8 sib-> do-> |
