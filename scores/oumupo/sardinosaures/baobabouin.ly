...
BaobabouinVoix = \relative do' {
  ...
  r4 r8 sol \times 2/3 {la,4 sol' la,} |
  \time 3/4
  do2.~ do8 do do re4 do8 |
  \time 4/4
  lab'1~ lab4 lab \times 2/3 { sib sol sib } |
  re,1~ re4 do \times 2/3 { do re do } |
  lab'1~ lab4\fermata \breathe sol \times 2/3 { la, sol' la, } |
...
BaobabouinPianoMd = \relative do' {
  \times 2/3 {<mi fa>8( la do} <fa, la mi'>4)-.
  ...
  <si re mi sol> <si re mi sol> <si re mi sol>8 <sib do mi sol>~ |
  <sib do mi sol>2. |
  ...
  R1
  r8 <do mi fa la>-. r4 r2 |
  r8 <si mib fa lab>-. r4 r2 |
  r4 <si do mi>( <fad' sol>)-. |
  \acciaccatura fad''8 <sol, sol'>4-. r2 |
  r4 <mi, fa la do>2 <mi fa do'>4 |
  ...
  <mi, sol la re>1:32\fermata ^ "(fill)"
}
...
BaobabouinPianoMg = \relative do {
  ...
  re4. re8 re4 la8 lab |
  sol4. sol8 sol4. fa8 |
  mi4 fa sol8 sold la si do4 dod |
  re4. re8 re4 la sol la si sol8 fa |
