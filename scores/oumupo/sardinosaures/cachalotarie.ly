...
CachalotarieVoix = \relative do' {
  \tempo "Allegro risoluto"
  re'4 sol8 re sol,4 mib8 fad sib re, do la' |
  fad4 r dod' dod8 la dod4 fad, sold si |
  ...
  mi4 fad si r8 dod |
  fa re mi do re sib mi8. do16 |
  fa4 re sol do,8 mib |
  si'4 r r red, |
  \times 2/3 {mi re dod} si r |
  r8 sol' r4 fa mib |
  fa, sol do lab8 sib |
  dod4 la8 si mi4 r8 re |
...
CachalotariePianoMd = \relative {
  r2 R1
  \clef treble la8 si dod re<fad la> re <mi sold> dod |
  <re fad> si <dod mi> la <si re> sold <la dod> mid |
  lab <sol sib> <lab do> <sib reb> <do mib>4 <sib fa'>8 lab |
  <sol mi'>4 \stemUp do8 re \stemNeutral mi fa sol lab |
  si sol do, la' mi sol re fad, |
  sib fa' lab' mib dob' reb, sib' solb, |
  fa' sib, la mi sol re do sib |
  la fad' mi' si la' dod, sold' red |
  re re, sib' mib, lab fa sol do, |
  <re fad> sol, <la dod> mi' <sib mib> solb' <do, fa> la' |
  <re, fa sold> si' <mi, la> do' <lad red fad>4 r |
  %%
  R1 do,8 re mi fa! sol la si do |
  dod red mid fad sold lad si dod |
  <fad, red'> <mi dod'> <red si'> <dod lad'> sold' fad mi red |
  <fa do'> do <mi la> la, <re fa> fa, <mi' sib'> sib |
  sol' sol, mib' mib, la' la, fa' fa, |
  <mi mi'>8 fad sold la si dod red mi |
  <dod fad> la <sold dod> mi <re sold> fad <si mi> sold |
  <sol do> mib <fa sib> re <fa' sib> sib, <mib fa> fa, |
  do' do' sol fa fa' do sol fa |
  <re' la'>4 r r2 |
  sid,,8 dod red mid fad sold lad sid |
  r4 \ottava #2 do''' \ottava 0 r2 |
  %%
  <sol,,,, si re sol>2 <sol sib mib sol> |
  ...
  red'''8 sold, mi red re' la fa mi |
  re' sib solb mib do' si sol mi |
  do' lab fa reb si' la fad dod |
  sib' mib, sol, re
...
CachalotariePianoMg = \relative {
  \clef bass
  r4 \ottava #-1 \pl
  { \acciaccatura fad,,,8 sol4 }
  { \acciaccatura fad'8 sol4}
  r \pl
  {\acciaccatura la,8 sib4}
  {\acciaccatura la'8 sib4}
  \ottava #0 r \pl
  {\acciaccatura re,8 mib4}
  {\acciaccatura re'8 mib4} |
  fad,8 sold la si dod4 si |
  la sold fad mi |
  fa8 sol fa mib reb4 sol |
  do, \stemDown \md do''8 \mg \stemNeutral sib
  lab sol fa mib |
  mi,4 sol' si la |
  mib, solb' sib dob |
  re,, fa' sol mi |
  ...
  si lad sold fad <mi dod'> <red si'> <dod lad'> <si sold'> |
  ...
  \clef treble reb8 mib fa sol lab sib do reb |
  \clef bass fad,,,, sol la si
  ...
  <la do mi> <la dod mi> |
  <sib re fa> <si re fad> |
  <do \parenthesize mib lab> <do mi sol> |
