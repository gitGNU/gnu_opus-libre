...
#(define-markup-list-command (paragraphe paper props text) (markup-list?)
...
#(let ((lower-case-accented-string "Ã©Ã¨ÃªÃ«Ã¡Ã Ã¢Ã¤Ã­Ã¬Ã®Ã¯Ã³Ã²Ã´Ã¶ÃºÃ¹Ã»Ã¼Ã§Å“Ã¦")
       (upper-case-accented-string "Ã‰ÃˆÃŠÃ‹Ã�Ã€Ã‚Ã„Ã�ÃŒÃŽÃ�Ã“Ã’Ã”Ã–ÃšÃ™Ã›ÃœÃ‡Å’Ã†"))
