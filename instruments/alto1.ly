...
ActeUnSceneQuatreAltoUn = { \AltoUn
  \relative {
    ...
    \t {r la--\upbow\mp( la--} \t {la-- la-- la--)}
    \t {la--( la-- la--)} \t {sib--( sib-- sib--)} |
    \t {r la--\upbow( la--} \t {la-- la-- la--)}
    \t {la--( la-- la--)} \t {sib--( sib-- sib--)} |
...
ActeDeuxSceneDeuxAltoUn = { \AltoUn
  \relative {
    ...
    <la sold'>4--->\f fa'8\upbow\< la sold | \acc {la\! la sold r4 |
    ...
    r16 \arco mi-.\pleggiero \st {do mi r red si red |
    r re sib re r dod la dod} |
    r \simile do lab do r si sol si r sib solb sib |
    ...
    sol8-- \st {mi,16\pleggiero mi r8 red16 red |
...
ActeDeuxSceneTroisAltoUn = { \AltoUn
  \relative {
    ...
    re4-.\p la'-. sold8( mi) | re4-. mi8( re) la'-. sold~-- |
    sold2.~ sold2 r4 |
    r8 re'( mi) r r mi-> r2 |
    r4 <si mi>~-- <si mi> r \clef treble \det {sold'8\mp sold la4 r |
    r2 sol8 sol sold4 r r2 sold8 sold la4} r |
    r sol2:16\p fad: sold4: si2: | sib: reb: sib4: |
    ...
    si'''4\ff r8 mib,16\> mib mib sib sib sib |
    re,2--\! r4 |
    ...
    sol) r2 \clef treble |
    \st {re4\mf la'} sold8( mi) re4-. mi8( re) la'( sold) r mi-. |
    sold4-- r r2 | <mi' re'>4-- sold8( mi) re4-- |
    <sold mi'>-> r r2 \clef alto |
    r4 r8 \st {sol,,\p r sol |
    R1 R2.

    %%% Soprano 1 %%%
    re'8\pp re r re r re r re re re r re r re |
    re re r re r re r re mi\p mi r mi r mi |
    mi mi r mi r mi r mi mid mid r mid r mid |
    r mid r mid r mid r mid} |
    R2. R1 R2. R1 R2. R1 R2.
    \st {sold8->\mf sold la4 r2 | r4 fad fad sol-> r r2 |
    R2. R1 R2. R1
    r2 sol8\p sol} sold( sold,) sol' sol sol( sold,) si' si \clef treble |
    do( do,) sold' sold la( la,) \simile sid' sid dod dod, sid' sid dod dod, |
    sold'\< la mi mi' fa fa, |

    %%% Duo %%%
    sold'4--\! r r2 \clef alto |
    sold,8\mf( la sold mi) re( mi) sold( la |
    ...
    %%% Baryton 2 %%%
    re8--->\fsubito \t {si16( do dod)} re8---> \t {sold,16( si dod)} re8---> fad,32( sold si dod) |
    ...
    \simile <re re'>4 <re re'> <re re'> <re re'> r2 \clef alto |
    \tt {re,16\mf( la sib do dod} re4->) \ttt {re16( fa, fad la sib re} |
    ...
    r8 sol--(\mp\downbow sol-- sol-- sol-- sol--) |
    lab--(\< lab-- si-- si-- do-- do--)\! |
    r do--( do-- do-- do-- do--) |
    dod--(\< dod-- mi-- mi-- fa-- fa--)\! |
    r \simile re re re re re dod dod fad fad fa fa |
    r fa fa fa fa fa | mi mi lab lab la la \clef treble |
    r \ind #"à la corde"
    sol\mp( si sol si sol) |
    si( sold mib' do mi do) \clef alto |
    r8 sol,-- fad( sib) si( sib) |
    re( si) do( re) mib4-- |

    %%% Contralto %%%
    re4->-- \pizz fad,\mp fad fad |
    fad r re'->\sfz r8 <fad, re'>\mp\arpeggUp |
    ...
    r <mib lab> r <mib lab> |
    r <mib lab> r <mib lab> |
    r4 \arco lab8->\mf lab-> la4-> r | R2.
    r4 sol8\p sol lab4---. r |
    r sold8 sold la4---. r | R2*2
    sold'8-.->\mf sold-. la4-. r |
    r sol8-. sol-. sold4-. |
    sold8-.-> sold-. la4-. r |
    r fad8-. fad-. sol4-. |
    ...
    red''8\mp red mi( mi,) red' red mi( mi,) |
    sol' sol lab( lab,) sol' sol lab( lab,) |
    \simile red red mi mi, red' red mi mi, |
    fad' fad sol sol, fad' fad sol sol, |
    mid' mid fad fad, red' red mi mi, |
    re' re red red, do' do dod dod, |
    \ind #"détaché"
    la'\mp la sold sold la la sold sold |
    dod dod sid sid dod dod do do |
    la la sold sold la la sold sold |
    dod\mf dod sid sid dod dod do do |
    ...
    mi2:16 mi4:16 |
    mi2:16 mi4:16 |
    sold2.\p~ sold\>~ sold sol2.\!~ sol~ sol2 r4 | R2.*2
    mi2:16\pp mi4:16 |
    mi2:16 mi4:16 |
    mi2:16 mi4:16 |
    mi2:16 mi4:16 |
    ...
    mi2:16 mi4:16 |
    mi2:16 mi4:16 |
    mi2-- r4 | r4 \ind #"senza sord." mi,2--\p~ mi2 r4 |
    mi'2.:32\< mi2.:32\mp\> mi2.\p \clef treble |
