...
PrologueClarinetteUn = { \ClarinetteUn
    ...
    re4 r | R2 \tt {fad,16 sol la do sib} mib4. red8 | mi4 r | r r8 \t {si16 re mi}|
...
ActeUnSceneUnClarinetteUn= { \ClarinetteUn
	\relative {
		R2*2 R2. R2*2 R2. |
		r8 do \t {do do do~} do2~ do r4 | r8 do \t {do do do~} do2~ do r4 |
		\t { fa,4 solb sib} do2~ do8 r r2 | \t {solb4 sib do} mib2~ mib8 r r2 |
...
ActeUnSceneDeuxClarinetteUn= { \ClarinetteUn
	\relative{
		...
		r4 sold'8 la sold mi re mi |	sold2 r4 sold8 la | sold mi re mi sold4~| sold2 r4 |
		r4 re'8 mib re sib lab sib | re2. r4 | r lab2 | r4 lab8 sib re mib | re2. r4 |
		r2 r4 si!8 dod | mid fad mid2~| mid2 r4 | si8 dod mid fad mid2~| mid4 r do!2\fermata |
		
		%%% Récitatif %%%
		
		R2.*2 R1 R2.*3 R1 R2.*4 \repeat tremolo 12 {mib32 mi!} | mib8 r r2 R2 R2. R1*2 R2.*4
...
ActeUnSceneTroisClarinetteUn= { \ClarinetteUn
	\relative{
		r4 r16 lab' lab lab | reb2 | r4 r16 lab lab lab | reb8 lab16 lab reb2 |
		r4 r8 lab16 lab | reb8 lab16 lab reb8. lab16 | lab lab lab lab r8 reb4 la!16 la|
		re!8 r r2 |
	}
}
...
ActeDeuxSceneUnClarinetteUn= { \ClarinetteUn
	\relative{
	R2.*3 | re''8 sib~ sib2~ | sib4 r | si!8 sol~ sol2~ | sol2 r4 | r sold | mi2.~ | mi2.~ | mi2.~ | mi4 r |
        R2. R2 R2.*2 r4 r8 la, | mi2.~ | mi2.~ | mi2.~ | mi4 r |
