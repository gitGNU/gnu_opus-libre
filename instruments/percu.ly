...
ActeDeuxSceneUnBisPercus = <<
  \new Staff { \Marimba
    \relative {
      ...
      %%% Moderato assai %%%
      \ind #"bag. douces"
      <do si'>1*7/4\pp\laissezVibrer s1*7/4
      ...
      <si do'>2.\pp\laissezVibrer r4 <do si'>2\laissezVibrer r2 <si do'>4\laissezVibrer |
      ...
      %%% Presto subito %%%
      \tt {fa,8->\f( mib' solb) do,( mib)} \tt {fa,->( mib' solb) do,( mib)}
      ...
      <do'' si'>2.\pp <si do'>2 <do si'> <si do'>2.\laissezVibrer R1*5/4*2
  ...
  \new DrumStaff { \Percus
    \drummode {
      ...
      r4 hh-- r8 hh4-- | R2.*4
      r4 \ind #"sur le bord" hh2:32~\pp\> hh4\! r2 |
      ...
      hh4->\! r r8 sn16 sn hh4-> r8 sn16 sn |
      hh4-> r8 sn16 sn hh4-> r r8 sn16 sn |
      hh4-> r1 | \ind #"Tam-Tam" cb2->\f\laissezVibrer r2 r4\fermata |
      R1*5/4*21
    }
  }
  \new Staff { \Timbales
    \relative {
      ...
      mib4\sfz r R4. r2 r8 \t {mib16\< mib mib} |
      mib4\sfz r R4. r2 r8 \t {mib16 mib mib} |
      mib4 mib8 mib mib |
      la,4-> r la4-> \t {la16\< la la} |
      la4\ff r8 la32-> la16. r4 |
      \det {la la la} sold4-> r16 sold32 sold sold8-> r4 |
      \det {sold\> sold sold |
      sol4\mp r2 | R2. sol4 r2 R2. sol4} r2 r2 r8 sol16\< sol |
      sol4\! r r8 \t {sol16\< sol sol} |
      sol4\! r2 r4 sol2:32\<\glissando sold2.\psubito\laissezVibrer
...
ActeDeuxSceneDeuxPercus = <<
  \new Staff { \Marimba
    \relative {
      ...
      la,2.\p\laissezVibrer \sustainOn r8 sol4.\laissezVibrer r2 |
      ...
      la'4\pp sol fa mi2 r4 |
      <solb, la! fa' lab>2.--\laissezVibrer R2.*4

      R2*2 R2.*2 R2*25
      <la' la'>2.\p\laissezVibrer \sustainOn R2.*6
      \pl {<fa do'>4--\pp do'-- fa,-- <fa do'>2*3/2--}
      {la'8( sol) fa( mi) fa16( mi fa sol) la8( mi8*5)\laissezVibrer }|
      R2.
      \pl {<la, do>4--\pp do-- la-- <la do>2.-- <sol re'>-- <la do>2--}
  ...
  \new DrumStaff { \Percus
    \drummode {
      ...
      R2*2 R2 R2. R1*3
      r4 \ind #"Tambour" \ind #"(bag. fagot)"  sn8\mf sn sn sn4-> r8 sn sn |
      sn4-> sn8 sn sn sn4-> r8 sn sn | sn4-> sn8\< sn16 sn sn sn |
      \acc {sn4\! sn} r16 sn32 sn | sn4-> r r8 |
  ...
  \new Staff { \Timbales
    \relative {
      ...
      r2 r8 \t {si16\< si si} |
      si4\mf si8 si32-> si16. r16 si si si r8 \t {si16\< si si} |
      sold4->\! r8 | si4--\mp r r8 sold r4 | si4 r r2 |
      si4\p r8 si r si r4 | si32-> si8.. r8 si r si r r16 si32 si |
      \cresc si4-> r8 si-- r si-- r4 | si-> r8 si-- r si-- r4 |
      sold2.:32~\fp\> sold4\! r r1 |
      ...
      mi,8 mi'16. mi32 mi4 |
      r4 re | dod1:32~\fp dod4 r2 |
      dod4\p r r2 r4 dod | sol1:32 | dod4 r r2 r4 dod |
      sol1.:32~ sol4 r2 | R1

      R2. R1 R2. R1 R2. R1 R2. R1 R2. R1 R2. R1 R2. R1
      R2. R1 R2. R1 R2. R1 r2 r8 r16 \t {la32\< la la} |
      la4\f r r r8 \t {la16\< la la} la4\! r r2 r8 \t {la16\< la la} |
      la1:32~\fp la:~ la2 r8 la\< \t {la la la} |
      la4->\f r r8 | R1*5/8*13 R1*6
      mi2:32~\fp mi8 mi\< \t {mi mi mi} |
      mi2:32~\fp mi8 mi\< \t {mi mi mi} |
      mi2:32~\fp\< mi8 mi \t {mi mi mi} |
      mi4->\f r2 | R2 R1*2 R2.*7
